...
Thread.sleep(13000);
tc1.test2("BTCUSDT","SELL","11500.00","0.091",3);//Unknown error
Thread.sleep(13000);
tc1.test2("BTCUSD","SELL","11500.00","0.019",4);//CANCELLED->null reason`
Thread.sleep(13000);
...
Thread.sleep(13000);
tc1.test2("BTCUSDT","BUY","12000.00","1.0010",15);
Thread.sleep(13000);
tc1.test2("BTCUSDT","BUY","12000.00","0.0015",16);
Thread.sleep(13000);
tc1.test2("BTCUSDT","BUY","12500.00","0.00120",17);

Thread.sleep(13000);
tc1.test2("BTCUSDT","SELL","12500.00","0.0015",18);
Thread.sleep(13000);
}}

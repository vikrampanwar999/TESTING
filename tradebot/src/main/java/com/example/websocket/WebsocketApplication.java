...
public class WebsocketApplication implements CommandLineRunner{
  ...
  /*  @EventListener(ApplicationReadyEvent.class)
	...
	public void run(String... args) throws Exception {
		...
		Thread.sleep(13000);
		//oderid list of oder
		tc1.test2("BTCUSDT","BUY","8800.00","4.001",5);// Insufficient funds (HTTP status code: 400)
		Thread.sleep(13000);
		tc1.test2("BTCUSDT","BUY","8070.00","0.010",6);//partial filled -> ORDER_EXEC_REPORT
		Thread.sleep(13000);
		tc1.test2("BTCUSDT","BUY","8370.00","1.010",7);
		Thread.sleep(13000);
		tc1.test2("BTCUSDT","BUY","9770.00","0.020",8);
		Thread.sleep(13000);
		tc1.test2("BTCUSDT","SELL","5070.00","0.00010",9);
		Thread.sleep(13000);
	}
}
